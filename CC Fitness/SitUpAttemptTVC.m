...
#import "SitUpAttemptTVC.h"
#import "SitUpLog+CoreDataClass.h"
#import "SitUpResultsVC.h"

@interface SitUpAttemptTVC ()
{
    SitUpLog *selectedEntry;
}

@end

@implementation SitUpAttemptTVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"sitUpCell"];
    
    // Configure the cell...
    
    if (cell == nil) {
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:@"sitUpCell"];
    }
    
    //Customize cells
    SitUpLog *entry = [self.attemptEntries objectAtIndex:indexPath.row];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    {
        SitUpResultsVC *vc = segue.destinationViewController;
