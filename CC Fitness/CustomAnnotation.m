...
+ (NSMutableArray *)GetAllAnnotations
{
    ...
    [AllAnnotations addObject:[[CustomAnnotation alloc]initWithLocation:CLLocationCoordinate2DMake(1.3547, 103.9399) title:@"Tampines ActiveSG Gym" andSubtitle:@"505 Tampines Avenue 5"]];
